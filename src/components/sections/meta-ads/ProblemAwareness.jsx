        ...
        <section className="py-24 relative bg-black/50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    <span className="text-red-500 font-bold tracking-wider text-sm uppercase mb-2 block">The Problem</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {problems.map((problem, idx) => (
                        <div key={idx} className="bg-white/5 hover:bg-white/10 p-8 rounded-2xl border border-white/10 transition-all hover:scale-[1.02] group">
