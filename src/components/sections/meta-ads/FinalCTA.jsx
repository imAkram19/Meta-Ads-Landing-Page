...
const FinalCTA = () => {
    return (
        <section className="py-32 relative overflow-hidden flex flex-col items-center text-center">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-blue-600/20 blur-[120px] rounded-full mix-blend-screen pointer-events-none" />
